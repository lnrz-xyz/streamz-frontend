...
const prettyReasons = {
  ...
  "contract splits": {
    ...
    incomplete: `Create Streamz offshoot NFTs on https://sound.xyz or https://zora.co and add the Streamz Split Address to the 0xSplit`,
...
const ScoreResults = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-full w-full px-8 py-4">
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between w-full py-8">
        <div className="flex flex-col md:max-w-[50vw] flex-wrap">
          <h4 className="text-4xl font-bold py-4">Increase Your Score</h4>
